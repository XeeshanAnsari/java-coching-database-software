...
PreparedStatement pst =null;
    ...
    private void Update_table(){
       ...
       try{
           String sql="Select * from Fee_inform where Class='B.S.C'";
           pst=conn.prepareStatement(sql);
           rs=pst.executeQuery();
           fee_table_five.setModel(DbUtils.resultSetToTableModel(rs));
       } catch(Exception e){
           JOptionPane.showMessageDialog(null, e);
           }finally{
          try{
        ...
        try{
           String sql="Select * from Fee_inform where Class='B.Com'";
           pst=conn.prepareStatement(sql);
           rs=pst.executeQuery();
           fee_table_six.setModel(DbUtils.resultSetToTableModel(rs));
       } catch(Exception e){
           JOptionPane.showMessageDialog(null, e);
           }finally{
          try{
    ...
    private void initComponents() {
        ...
        fee_table_five = new javax.swing.JTable();
        ...
        combo_five = new javax.swing.JComboBox<>();
        jPanel8 = new javax.swing.JPanel();
        jScrollPane6 = new javax.swing.JScrollPane();
        fee_table_six = new javax.swing.JTable();
        ...
        combo_six = new javax.swing.JComboBox<>();
        ...
        fee_table_five.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane5.setViewportView(fee_table_five);
        ...
        Search_table_five.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Search_table_fiveActionPerformed(evt);
            }
        });
        ...
        combo_five.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Search", "G_R no", "Name", "Month" }));
        combo_five.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                combo_fiveActionPerformed(evt);
            }
        });
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                .addGap(15, 15, 15)
                .addComponent(combo_five, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(15, 15, 15)
                .addComponent(Search_table_five, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(combo_five, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(0, 20, Short.MAX_VALUE))
        );

        jTabbedPane1.addTab("B.S.C", jPanel7);

        jPanel8.setOpaque(false);

        fee_table_six.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane6.setViewportView(fee_table_six);
        ...
        Search_table_six.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Search_table_sixActionPerformed(evt);
            }
        });
        ...
        combo_six.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Search", "G_R no", "Name", "Month" }));
        combo_six.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                combo_sixActionPerformed(evt);
            }
        });
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                .addGap(15, 15, 15)
                .addComponent(combo_six, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(15, 15, 15)
                .addComponent(Search_table_six, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(Delete_table_six)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(print_table_six)
                .addContainerGap())
            .addComponent(jScrollPane6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 787, Short.MAX_VALUE)
        );
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(combo_six, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(0, 20, Short.MAX_VALUE))
        );

        jTabbedPane1.addTab("B.Com", jPanel8);

        getContentPane().add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 50, -1, 596));
    ...
    private void Search_table_twoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Search_table_twoActionPerformed
        // TODO add your handling code here:
    ...
    private void print_table_fiveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_print_table_fiveActionPerformed
     ...
     MessageFormat footer =new MessageFormat("page{0,number,integer}");
        try{
          fee_table_five.print(JTable.PrintMode.NORMAL,header,footer);
      }catch(java.awt.print.PrinterException e){
    ...
    private void Delete_table_fiveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Delete_table_fiveActionPerformed
       try{
             String sql= "delete  from   Fee_inform where G_R_number=?";
             int row =fee_table_five.getSelectedRow();
           String Tabel_click=(fee_table_five.getModel().getValueAt(row, 0).toString());
           pst=conn.prepareStatement(sql);
           pst.setString(1, Tabel_click);
           pst.execute();
           JOptionPane.showMessageDialog(null," Deleted" );
    ...
    private void Search_table_fiveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Search_table_fiveActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Search_table_fiveActionPerformed
    ...
    private void Search_table_fiveKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Search_table_fiveKeyReleased
        String search= Search_table_five.getText();    
           String combo= combo_five.getSelectedItem().toString();
        ...
        case "G_R no":
            try{
                String sql="Select * from Fee_inform where Class ='B.S.C' and G_R_Number='"+search+"'";
                pst= conn.prepareStatement(sql);
                rs=pst.executeQuery();
                fee_table_five.setModel(DbUtils.resultSetToTableModel(rs));
        ...
        case "Name":
            try{
                String sql="Select * from Fee_inform where Class ='B.S.C' and Name='"+search+"'";
                pst= conn.prepareStatement(sql);
                rs=pst.executeQuery();
                fee_table_five.setModel(DbUtils.resultSetToTableModel(rs));
        ...
        case "Month":
            try{
                String sql="Select * from Fee_inform where  Class ='B.S.C' and Month='"+search+"'";
                pst= conn.prepareStatement(sql);
                rs=pst.executeQuery();
                fee_table_five.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void combo_fiveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combo_fiveActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_combo_fiveActionPerformed
    ...
    private void print_table_sixActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_print_table_sixActionPerformed
     ...
     MessageFormat footer =new MessageFormat("page{0,number,integer}");
        try{
          fee_table_six.print(JTable.PrintMode.NORMAL,header,footer);
      }catch(java.awt.print.PrinterException e){
    ...
    private void Delete_table_sixActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Delete_table_sixActionPerformed
        try{
             String sql= "delete  from   Fee_inform where G_R_number=?";
             int row =fee_table_six.getSelectedRow();
           String Tabel_click=(fee_table_six.getModel().getValueAt(row, 0).toString());
           pst=conn.prepareStatement(sql);
           pst.setString(1, Tabel_click);
           pst.execute();
           JOptionPane.showMessageDialog(null," Deleted" );
    ...
    private void Search_table_sixActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Search_table_sixActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Search_table_sixActionPerformed
    ...
    private void Search_table_sixKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Search_table_sixKeyReleased
       String search= Search_table_six.getText();    
           String combo= combo_six.getSelectedItem().toString();
        ...
        case "G_R no":
            try{
                String sql="Select * from Fee_inform where Class ='B.Com' and G_R_Number='"+search+"'";
                pst= conn.prepareStatement(sql);
                rs=pst.executeQuery();
                fee_table_six.setModel(DbUtils.resultSetToTableModel(rs));
        ...
        case "Name":
            try{
                String sql="Select * from Fee_inform where Class ='B.Com' and Name='"+search+"'";
                pst= conn.prepareStatement(sql);
                rs=pst.executeQuery();
                fee_table_six.setModel(DbUtils.resultSetToTableModel(rs));
        ...
        case "Month":
            try{
                String sql="Select * from Fee_inform where  Class ='B.Com' and Month='"+search+"'";
                pst= conn.prepareStatement(sql);
                rs=pst.executeQuery();
                fee_table_six.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void combo_sixActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combo_sixActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_combo_sixActionPerformed
